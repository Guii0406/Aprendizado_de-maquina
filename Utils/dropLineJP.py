...
# carrega a tabela
tabela = pd.read_excel("/home/guii0406/Documentos/Aprendizado_de-maquina/Databases/Guaratuba/airbnb_guaratuba.xlsx")
...
tabela_sem_vazios_e_total_sem_impostos.to_excel('airbnb-Guaratuba-filtrado.xlsx')
