...
# carrega a tabela
tabela = pd.read_excel("D:\\Importante\\Aprendizado_de-maquina\\airbnb-Cascavel-1.xlsx")
...
tabela_sem_vazios_e_total_sem_impostos.to_excel('airbnb-Cascavel-filtrado.xlsx')
