...
# carrega a tabela
tabela = pd.read_excel("C:\\Users\\dagos\\OneDrive\\Desktop\\Aprendizado_de-maquina\\airbnb-foz.xlsx")
...
tabela_sem_vazios_e_total_sem_impostos.to_excel('airbnb-foz-do-iguacu.xlsx')
